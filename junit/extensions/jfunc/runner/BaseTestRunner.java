...
public abstract class BaseTestRunner {
    ...
    public Test getTest(String suiteClassName) {
        return getTest(suiteClassName, new String[0]);
    }

    public Test getTest(String suiteClassName, String[] args) {
...
//          }
    ...
    public static String getFilteredTrace(Throwable t) { 
        return getFilteredTrace(t, false);
    }

    /**
     * Returns a filtered stack trace
     */
    public static String getFilteredTrace(Throwable t, boolean justMessage) { 
        StringWriter stringWriter= new StringWriter();
        PrintWriter writer= new PrintWriter(stringWriter);
        t.printStackTrace(writer);
        StringBuffer buffer= stringWriter.getBuffer();
        String trace= buffer.toString();
        return (justMessage ? t.getMessage() + "\n" : "") 
            + BaseTestRunner.filterStack(trace, justMessage);
    }

    public static String filterStack(String stack) {
        return filterStack(stack, false);
    }
     ...
     */
    public static String filterStack(String stack, boolean justMessage) {
        if (!getPreference("filterstack").equals("true") 
            || fgFilterStack == false)
            return stack;
    ...
    static String[] loadPatterns() {
        // XXX this should be dynamically loaded from a properties file
        return new String[] {
            "junit.extensions.jfunc"
        };
    }

    static String[] combine(String[] x, String[] y) {
    ...
    static boolean filterLine(String line) {
        ...
        // load other patterns
        patterns = combine(patterns, loadPatterns());
